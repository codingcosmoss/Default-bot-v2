...
return new class extends Migration
{
    ...
    {
        Schema::create('imported_medicines', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('amount')->default(0)->comment('Olib kelingan dori miqdori');
    ...
    {
        Schema::dropIfExists('imported_medicines');
    }
};
