...
class ProductService extends AbstractService
{
    ...
    {
        return [
            TextField::make('name')->setRules('required|min:2|max:255'),
            TextField::make('price')->setRules('required|integer'),
            TextField::make('bar_code')->setRules('nullable|min:3|max:255'),
            TextField::make('vendor_code')->setRules('nullable|min:3|max:255'),
    ...
    public function store(array $data)
    {
        ...
        try {
            ...
            $model->bar_code = isset($data['bar_code']) ? $data['bar_code'] : '' ;
            $model->vendor_code = isset($data['vendor_code']) ? $data['vendor_code'] : '' ;
