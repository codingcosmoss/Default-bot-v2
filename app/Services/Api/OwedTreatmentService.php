...
use App\Http\Resources\OwedTreatmentResource;
...
class OwedTreatmentService extends AbstractService
{
    ...
    protected $model = OwedTreatment::class;
    protected $resource = OwedTreatmentResource::class;
     ...
     * @return array
     */
    public function getDebtFields()
    {
        return [
            TextField::make('authorizing')->setRules('required'),
            TextField::make('return_at')->setRules('required|date'),
    ...
    public function store(array $data)
    {
        ...
        try {
            ...
            $model->authorizing = $data['authorizing'];
            $model->return_at = $data['return_at'];
            $model->treatment_id = $data['treatment_id'];
            $model->patient_id = isset($data['patient_id']) ? $data['patient_id'] : null;
