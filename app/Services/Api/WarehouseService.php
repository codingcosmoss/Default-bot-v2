...
class WarehouseService extends AbstractService
{
    ...
    public function getFields()
    {
        return [
            ...
            TextField::make('filial_id')->setRules('nullable|integer'),
            TextField::make('warehouse_category_id')->setRules('required|integer'),
    ...
    public function store(array $data)
    {
        ...
        try {
            ...
            $model->filial_id = isset($data['filial_id']) ? $data['filial_id'] : null ;
            $model->warehouse_category_id = isset($data['warehouse_category_id']) ? $data['warehouse_category_id'] : null ;
