        ...
        <div
            ...
            <div class="flex flex-col">
                ...
                <div class="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
                    <div class="flex items-center gap-3 p-2.5 xl:p-5">
                        <div class="flex-shrink-0">
                            <img src="http://127.0.0.1:8000/images/brand/brand-01.svg" alt="Brand" />
                        </div>
                ...
                <div class="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
                    <div class="flex items-center gap-3 p-2.5 xl:p-5">
                        <div class="flex-shrink-0">
                            <img src="http://127.0.0.1:8000/images/brand/brand-03.svg" alt="Brand" />
                        </div>
                ...
                <div class="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
                    <div class="flex items-center gap-3 p-2.5 xl:p-5">
                        <div class="flex-shrink-0">
                            <img src="http://127.0.0.1:8000/images/brand/brand-04.svg" alt="Brand" />
                        </div>
                ...
                <div class="grid grid-cols-3 sm:grid-cols-5">
                    <div class="flex items-center gap-3 p-2.5 xl:p-5">
                        <div class="flex-shrink-0">
                            <img src="http://127.0.0.1:8000/images/brand/brand-05.svg" alt="Brand" />
                        </div>
