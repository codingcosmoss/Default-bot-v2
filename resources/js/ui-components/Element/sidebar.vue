      ...
      <nav class="mt-5 py-4 px-4 lg:mt-9 lg:px-6" x-data="{selected: $persist('Dashboard')}">
        ...
        <div>
          ...
          <ul class="mb-6 flex flex-col gap-1.5">
            ...
            <li>
              <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                href="profile.html" @click="selected = (selected === 'Profile' ? '' : 'Profile')" :class="{
                  'bg-graydark dark:bg-meta-4': (selected === 'Profile') && (page === 'profile'),
                  'bg-graydark': page === 'profile' && selected !== 'Profile'
                }">
                <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <li>
              <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                ...
                :class="{
        'bg-graydark dark:bg-meta-4': selected === 'Settings' && page === 'settings',
        'bg-graydark': page === 'settings' && selected !== 'Settings'
    }" >
