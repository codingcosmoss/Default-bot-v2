            ...
            <div class="flex flex-col">
                ...
                <div class="grid grid-cols-3 rounded-sm mb-2 sm:grid-cols-5 relative">
                    ...
                    <div class="flex flex-wrap gap-5 xl:gap-20" style="position: absolute; right: 0px; top: 0">
                        <a @click = "this.$router.push('/patient/create')"
                ...
                <div v-for="(item, index) in items" class="grid grid-cols-7 border-b border-stroke dark:border-strokedark sm:grid-cols-7">
                    ...
                    <div class="flex items-center gap-3 p-2.5 xl:p-5">
                        <p class="font-medium hidden text-black dark:text-white sm:block">{{index+1}}.  {{item.first_name}}</p>
                    </div>
...
import {patients, patientShow, patientCreate, patientDelete, patientsSearch, patientUpdate} from "../../../Api.js"
...
export default {
    components: {
        ...
        CreateForm,
        ShowForm,
        ModalLayout, Input, VueAwesomePaginate,InputDefault, PaginateBtn, TableHeader},
    data(){
        return{
            items: [],
            search: '',
