<template>
    <div id="printThisArea">
        ...
        <h3 style="margin: 14px 0 !important; text-align: end !important">{{getName('Payment')}}: {{counterStore.formatNumber(TotalSum - Discount)}}</h3>
        <h3 style="margin: 14px 0 !important; text-align: end !important">{{getName('Paid')}}: {{counterStore.formatNumber((TotalSum - Discount) - Indebtedness)}}</h3>
