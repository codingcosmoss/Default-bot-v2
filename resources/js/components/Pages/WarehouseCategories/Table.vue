...
//
import {
    warehouseCategoryShow,
    warehouseCategoryDelete,
    warehouseCategoryCreate,
    warehouseCategorys, warehouseCategoryUpdate, warehouseCategorySearch
} from "../../../Api.js"
...
export default {
    ...
    methods:{
        ...
        async getModel(){
            const response = await warehouseCategoryShow(this.UpdatedId);
        ...
        async crudCategory(){
            ...
            if(this.crud == 'created'){
                response = await warehouseCategoryCreate(data);

            }else {
                response = await warehouseCategoryUpdate( this.UpdatedId, data);
            }
        ...
        async getItems(){
            const response = await warehouseCategorys(this.currentPage, this.paginateCount);
        ...
        async clickSearch(val, order){
            ...
            if (val != ''){
                ...
                const response = await warehouseCategorySearch(data);
                console.log(response)
                this.items = response.data.items;
            }else {
                this.getItems()
        ...
        async onDelete(val){
            ...
            if (confirm(message)){
                const response = await warehouseCategoryDelete(val);
