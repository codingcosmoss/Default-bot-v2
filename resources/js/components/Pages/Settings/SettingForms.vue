            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div class=" flex flex-col gap-6 xl:flex-row p-6.5" >
                    <Input
                        :Couple = "false"
                        style="width: 100%"
                        :Label = "getName('BotToken')"
                        @onInput = "bot_token = $event"
                        :isError = "hasKey('bot_token')"
                        :message = "errorObj['bot_token']"
                        :Value = "bot_token"
                    />
                ...
                <div class=" pl-7 p-6.5">
                    <button  @click="companySetting()" class="flex w-full justify-center rounded bg-primary p-3 font-medium text-gray">
                        {{getName('Save')}}
                    </button>
                </div>
