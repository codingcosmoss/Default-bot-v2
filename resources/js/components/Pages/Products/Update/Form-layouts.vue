...
import {productShow, productUpdate, groups} from "../../../../Api.js";
...
export default {
    computed: {
        ...
        async getModel(){
            ...
            this.BarCode = product.bar_code
            this.WendorCode = product.vendor_code
            this.GroupID = product.group_id
            this.SizeType = product.size_type
        ...
        async update(){
            ...
            const response = await productUpdate(this.$route.query.id , data);
