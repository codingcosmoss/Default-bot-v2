...
import {
    ...
    filialCreate,
    filialsSearch,
    filialUpdate, filialDelete, filials
} from "../../../Api.js"
...
export default {
    ...
    methods:{
        ...
        async getModel(){
            const response = await filialShow(this.UpdatedId);
        ...
        async crudCategory(){
            ...
            if(this.crud == 'created'){
                response = await filialCreate(data);

            }else {
                response = await filialUpdate( this.UpdatedId, data);
            }
        ...
        async getItems(){
            const response = await filials(this.currentPage, this.paginateCount);
        ...
        async clickSearch(val, order){
            ...
            if (val != ''){
                ...
                const response = await filialsSearch(data);
                console.log(response)
                this.items = response.data.items;
            }else {
                this.getItems()
        ...
        async onDelete(val){
            ...
            if (confirm(message)){
                const response = await filialDelete(val);
