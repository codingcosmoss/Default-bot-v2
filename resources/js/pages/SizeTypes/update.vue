            ...
            <BaseBox Col="col-xl-12" Title="">
                ...
                <div class="row">
                    ...
                    <div class="col-12 d-flex flex-column">
                        ...
                        <input type="checkbox" id="size_type_update" switch="none" @input="status = status == 1 ? 0 : 1" :checked="status == 1 ? true : false" >
                        <label for="size_type_update" data-on-label="On" data-off-label="Off"></label>
                    </div>
                </div>
