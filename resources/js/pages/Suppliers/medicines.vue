...
import {
    ...
    imported_medicines, imported_medicinePaginates, imported_medicineSearch, imported_medicineSupplierMedicines
} from "@/helpers/api.js";
    ...
    methods:{
        async indexPaginates(page=1, islaoder = true){
            try {
                ...
                const response = await imported_medicineSupplierMedicines(this.$route.query.id, page);
