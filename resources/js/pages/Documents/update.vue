<template>
    <!--    Modal   -->
    <ModalCentered :Title="$t('NewImportMedicines')" ModalName="documentUpdate"  :isModalFooter="false">
        <div class="row"  >
            ...
            <BaseBox Col="col-xl-12" Title="">
                ...
                <div class="row">
                    ...
                    <ImageInput
                        ...
                        @documentUpdateFile="file = $event, delete this.errors.image"
                        :Validated="errors"
                        Accept="*"
                    />
...
import {
    documentCreate, documentUpdate, suppliers, warehouses
} from "../../helpers/api.js";
    ...
    methods: {
        ...
        async update() {
            try {
                ...
                const response = await documentUpdate(this.Item.id,data);
                if (response.status) {
                    Alert('success', this.$t('update'));
                    this.save();
                    this.loader = false;
                    this.errors = [];
                    this.counterStore.hiddenModal('documentUpdate');
